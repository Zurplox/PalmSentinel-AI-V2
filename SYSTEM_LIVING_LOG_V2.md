...
### [2026-09-24] - Deep tackle on missed palms: chains found, second-chance refuted, no code changed

Owner insisted detections miss real crowns. Kill-chain replay on demo (628 candidates): victims' peak median 123 vs keepers 137, 36% within 90% of killer brightness, 71.5% killed at 100-160 px, prime victims' rosette median 1.24 m (90% >= 1.0 m) - palm-like in every single-image feature. Prototype rosette-gated second chance reinstated 322 and collapsed NN mode to 3.62 m (frond regime): rosette does NOT separate buds from fronds, hypothesis dead, not shipped. Young standard on demo: 167 vs 140 (+27 only, NN mode 5.95) - no hidden army. Conclusion recorded: 4-6 m band is fundamentally ambiguous in single RGB (brightness chains are the fixture gap - uniform synthetic has none); floor trades along a measured elbow (clean >=5.6 m, grey 4.8 m, fronds below); zone-by-age workflow + operator corrections remain the answer; settling needs hand labels.

### [2026-09-24] - Dense-mature standard (owner: make it more sensitive, without counting fronds)

Owner rejected guidance-only answers and demanded a fix. Five single-image discriminators were measured dead (brightness, rosette size, local contrast, gradient-orientation entropy, coarse/fine blur ratio - identical across kept, prime victims and frond kills); a rosette-gated second-chance prototype reinstated 322 and collapsed NN mode to 3.62 m, refuted and not shipped. Floor sweep on the owner's frame: 6.75 m -> 1,687 (NN 7.2, clean); 5.62 m -> 2,228 (NN 6.4, clean); 4.77 m -> 2,601 (NN mode 5.0, grey zone); below ~4 m fronds. Shipped instead: third standard 'dense' (9 m grid assumption, mature optics, 0.65 fraction -> 5.85 m floor), opt-in per zone, default untouched. Measured: demo 154 (+14, NN mode 7.49); synthetic 9 m identical to mature; whole mosaic 2,143 (NN 6.53/6.56). Suite 105/105. Released as v2.0.9.
